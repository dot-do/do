/**
 * @dotdo/do - REST API Tests (GREEN Phase)
 *
...
describe('HATEOAS REST API', () => {
  ...
  beforeEach(() => {
    const name = uniqueTestName('rest-api')
  ...
  describe('API Routes (/api)', () => {
    ...
    describe('GET /api/:resource', () => {
      ...
      it('should support orderBy query parameter', async () => {
        await runInDurableObject(stub, async (instance) => {
          // Use created_at (the actual database column name)
          const request = new Request('https://database.do/api/users?orderBy=created_at&order=desc')
          const response = await (instance as any).handleRequest(request)
    ...
    describe('GET /api/:resource/:id', () => {
      it('should return document with HATEOAS links', async () => {
        await runInDurableObject(stub, async (instance) => {
          ...
          const createResponse = await (instance as any).handleRequest(createRequest)
    ...
    describe('DELETE /api/:resource/:id', () => {
      it('should delete document', async () => {
        await runInDurableObject(stub, async (instance) => {
          ...
          const getResponse = await (instance as any).handleRequest(getRequest)
...
describe('Monaco Editor Routes (/~)', () => {
  ...
  beforeEach(() => {
    const name = uniqueTestName('monaco-editor')
    stub = createTestStub(name) as DOStub
  })
  ...
  describe('GET /~/:resource/:id', () => {
    it('should return Monaco editor HTML', async () => {
      await runInDurableObject(stub, async (instance) => {
        ...
        await (instance as any).create('users', { id: 'test-user', name: 'Test' })
