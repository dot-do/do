/**
 * @dotdo/do - getOrGenerate() Tests (GREEN Phase - do-a06)
 *
...
describe('getOrGenerate() - Lazy Execution with Caching', () => {
  afterEach(() => {
    vi.useRealTimers()
  })
  ...
  describe('Cache Miss - Calls Generator and Caches Result', () => {
    ...
    it('should pass the key to the generator function', () => {
      ...
      expect(generator).toHaveBeenCalledWith('myKey', undefined)
  ...
  describe('Stale-While-Revalidate Pattern', () => {
    ...
    it('should only trigger one background refresh for concurrent requests', async () => {
      ...
      // These return stale values synchronously but trigger background revalidation
  ...
  describe('Concurrency and Race Conditions', () => {
    ...
    it('should handle generator timeout with timeout option', async () => {
      ...
      const promise = cache.getOrGenerate('key', slowGenerator, { timeout: 100 })
