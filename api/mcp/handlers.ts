 ...
 * Maps MCP tool calls to DO RPC methods.
 */
...
/**
 * Get all available MCP tools for a DO
 */
export function getTools(): MCPTool[] {
  const tools: ToolDef[] = [
    ...
    // Collection CRUD
    ...getCollectionTools('nouns', 'Noun', 'entity type definitions'),
    ...getCollectionTools('verbs', 'Verb', 'action type definitions'),
    ...getCollectionTools('things', 'Thing', 'instances of nouns'),
    ...getCollectionTools('actions', 'Action', 'durable action instances'),
    ...getCollectionTools('relationships', 'Relationship', 'connections between things'),
    ...getCollectionTools('functions', 'Function', 'executable functions'),
    ...getCollectionTools('workflows', 'Workflow', 'durable workflows'),
    ...getCollectionTools('events', 'Event', 'immutable event records'),
    ...getCollectionTools('users', 'User', 'user identities'),
    ...getCollectionTools('agents', 'Agent', 'autonomous AI agents'),
    ...getCollectionTools('integrations', 'Integration', 'external service connections'),
 ...
 */
function getCollectionTools(collection: string, type: string, description: string): ToolDef[] {
  return [
    {
...
export async function handleToolCall(
  ...
  try {
    ...
    if (toolName.startsWith('ai.')) {
      ...
      const response = await stub.fetch(new Request(`https://${hostname}/rpc`, {
        method: 'POST',
